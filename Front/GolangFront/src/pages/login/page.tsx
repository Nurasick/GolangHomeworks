...
function LoginPage() {
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 to-slate-800">
            <div className="w-full max-w-md rounded-2xl bg-white/10 backdrop-blur-lg shadow-xl p-8" >
                ...
                <p className="text-sm text-gray-300 mt-2">Log in to continue</p>
                <div className="mt-6">
                ...
                transition
                ">Log in</button>
                <p className="text-sm text-gray-400 mt-6 text-center">Don't have an account?  
                    <Link to="/register" className="text-indigo-400 hover:underline cursor-pointer"> Sign up</Link>
                </p>
                </form>
                </div>
            </div>
